                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="Alterar_Agendamento.php?idCat=<?php echo $exibe["idAgendamento"]; ?>" class="btn btn-info form-control" role="button">Alterar</a>
                            </td>
                            <td>
                                <a href="#" class="btn btn-danger form-control" role="button" data-toggle="modal" data-target="#modalExclusao" title="Excluir Agendamento" onclick="salvaId('<?php echo $exibe['idAgendamento']; ?>'">Excluir</a>
                            </td>
                        </tr>
                    <?php
                    }
            ...
            <div class="modal-dialog modal-dialog-centered ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button name="excluirBtn" id="excluirBtn" type="submit" class="btn btn-danger" data-dismiss="modal" onclick="apagarRegistro(idAgendamento);">
                            Excluir
                        </button>
